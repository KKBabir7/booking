...
@push('styles')
  ...
  <style>
    ...
    .auth-input:focus {
      border-color: #f76156;
      box-shadow: 0 0 0 0.25 anonymous rgba(247, 97, 86, 0.1);
    }
    ...
    .btn-auth-primary:hover {
      ...
      box-shadow: 0 5px 15px rgba(247, 97, 86, 0.3);
      color: white;
    }
  </style>
@endpush
          ...
          <div class="auth-card shadow-lg border-0 overflow-hidden d-flex flex-column" style="border-radius: 20px;">
            <div class="row g-0 flex-grow-1 align-items-stretch">
              ...
              <div class="col-md-6 p-4 p-lg-5 bg-white">
                <div class="auth-box">
                  <h2 class="auth-title mb-1 text-center fw-bold" style="color: #2d3436;">Log In</h2>
                  ...
                  <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-4">
                      ...
                      @if (Route::has('password.request'))
                        <a href="{{ route('password.request') }}" class="text-muted small text-decoration-none">Forgot
                          password?</a>
                      @endif
                    </div>

                    <div class="text-center">
                      <button type="submit" class="btn btn-auth-primary px-5 py-2 w-100">LOG IN</button>
                    </div>
                  </form>
                </div>
              </div>
              ...
              <!-- Right: Overlay side -->
              <div class="col-md-6 auth-overlay d-flex align-items-center justify-content-center text-center p-4 p-lg-5"
                style="background: linear-gradient(135deg, #f76156, #ff8e86); color: white;">
                <div class="overlay-panel">
                  ...
                  <a href="{{ route('register') }}" class="btn btn-outline-light rounded-pill px-5 py-2 fw-bold">SIGN
                    UP</a>
                </div>
              </div>
            </div>
