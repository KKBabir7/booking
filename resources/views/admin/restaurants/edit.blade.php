            ...
            <div class="space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        ...
                        <input type="number" step="0.01" name="advance_amount" value="{{ old('advance_amount', $restaurant->advance_amount) }}" required
                ...
                <div class="space-y-2">
                    ...
                    @if($restaurant->image)
                        <div class="mb-3 p-2 bg-slate-50 border border-slate-200 rounded-2xl inline-block">
                            <img src="{{ asset('storage/' . $restaurant->image) }}" class="h-24 w-auto rounded-xl shadow-sm">
                            <p class="text-[10px] text-center text-slate-400 font-bold mt-1">Current Image</p>
                        </div>
                    @endif
                ...
                <div class="flex items-center gap-3 p-4 bg-slate-50 border border-slate-100 rounded-2xl">
                    <input type="checkbox" name="is_active" id="is_active" value="1" {{ $restaurant->is_active ? 'checked' : '' }} class="w-5 h-5 text-indigo-600 border-slate-200 rounded focus:ring-indigo-500">
