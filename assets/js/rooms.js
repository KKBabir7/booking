...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function updateFromInput() {
        ...
        let maxVal = parseInt(maxInput.value) || parseInt(maxRange.max);
    ...
    function matchesFilters(card, filters) {
        ...
        const rawPrice = parseFloat(card.getAttribute('data-price') || '0');
        const price = rawPrice * (window.exchangeRate || 1);
    ...
    function updateDisplay() {
        const filters = {
            ...
            maxPrice: maxRange ? parseInt(maxRange.value) : parseInt(maxRange.max)
        };
    ...
    if (resetBtn) {
        resetBtn.addEventListener('click', function(e) {
            ...
            if (minRange && maxRange) {
                // Read from button attribute first, fallback to current range max attribute
                const dynamicMax = parseInt(resetBtn.getAttribute('data-max')) || parseInt(maxRange.max) || 1000;
                minRange.value = 0;
                maxRange.value = dynamicMax;
                updateSlider();
            }
